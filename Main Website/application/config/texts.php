...
return array(
	...
	"FEEDBACK_USERPHONENUMBER_FIELD_EMPTY" => "The phone number field was empty.",
	...
	"FEEDBACK_USERPHONENUMBER_DOES_NOT_FIT_PATTERN" => "Your phone number is to long or to short, do not add any spaces inbetween numbers.",
