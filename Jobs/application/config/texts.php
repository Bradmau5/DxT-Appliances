...
return array(
	...
	"FEEDBACK_JOB_CREATED_SUCCESS" => "Job created successfully.",
	"FEEDBACK_JOB_CREATED_FAILED" => "Job failed to create.",
	"FEEDBACK_JOB_EDITING_FAILED" => "Job editing failed.",
	"FEEDBACK_JOB_EDITING_SUCCESS" => "Job editing successful.",
	"FEEDBACK_JOB_DELETION_FAILED" => "Failed to delete job.",
	"FEEDBACK_JOB_COMPLETE_MAIL_SENDING_SUCCESSFUL" => "Sent job completion notice to account holder.",
	"FEEDBACK_JOB_COMPLETE_MAIL_SENDING_FAILED" => "Failed to job completion notice to account holder.",
	"FEEDBACK_VEHICLE_CREATED_SUCCESS" => "Successfully created new vehicle.",
	"FEEDBACK_VEHICLE_CREATED_FAILED" => "Failed to create new vehicle.",
	"FEEDBACK_STOCK_UPDATED_FAILED" => "Failed to update stock amount.",
	"FEEDBACK_STOCK_UPDATED_SUCCESS" => "Successfully updated stock amount.",
	"FEEDBACK_USER_UPDATED_FAILED" => "Failed to update users account.",
	"FEEDBACK_USER_UPDATED_SUCCESS" => "Successfully updated user account.",
	"EMAIL_INVOICE_FROM_EMAIL" => "invoice@dxtappliances.co.uk",
	"EMAIL_INVOICE_SUBJECT" => "Invoice from DxT Appliances",
	"EMAIL_INVOICE_FROM_NAME" => "DxT Appliances Invoice System",
	"FEEDBACK_ITEM_ADDED_TO_STOCK_SUCCESS" => "Successfully added a new item to the inventory.",
	"FEEDBACK_ITEM_ADDED_TO_STOCK_FAILE" => "Failed to add a new item to the inventory.",
);