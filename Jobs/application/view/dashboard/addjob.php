<div class="container">
	...
	<div class="jobform">
		...
		<p>
        <form method="post" action="<?php echo Config::get('URL');?>dashboard/create" style="width: 60%;">
	...
	<input name="custom_field"  placeholder="Street" /><br />
    	...
    	<input class="postcode" name="postcode"  placeholder="Postcode" />
	...
	<label for="login_input_jobmt">Machine Type: </label>
        ...
        <label for="login_input_jobfor">Assign Job To: </label>
        <select name="job_for">
            <?php
		if($this->user){			
			foreach($this->user as $key=>$value){
				if($value->user_engineer == 1){
