  ...
  class LoginModel
  {
    ...
    public static function login($user_name, $user_password, $set_remember_me_cookie = null)
    {
      ...
      if ($result->user_deleted == 1) {
        Session::add('feedback_negative', Text::get('FEEDBACK_ACCOUNT_DELETED'));
        return false;
      }
    ...
    public static function saveTimestampOfLoginOfUser($user_name)
    {
      ...
      $sql = "UPDATE BDL_Users SET user_last_login_timestamp = :user_last_login_timestamp
    ...
    public static function setRememberMeInDatabaseAndCookie($user_id)
    {
      ...
      $sql = "UPDATE BDL_Users SET user_remember_me_token = :user_remember_me_token WHERE user_id = :user_id LIMIT 1";
      $sth = $database->prepare($sql);
